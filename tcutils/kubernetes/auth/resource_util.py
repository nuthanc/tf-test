...
class ResourceUtil(Util):
    ...
    def create_policy_and_perform_operations(
            ...
            stackrc_dict={},
            inputs=None):
        create_policy.create_and_apply_policies(resource=resource, match=match, inputs=inputs)
    ...
    def perform_operations(
            ...
            namespace='default',
            inputs=None):
        stackrc_file = Util.source_stackrc_to_file(**stackrc_dict, inputs=inputs)
