...
class BetaTestResource(BaseK8sTest):
...
class Manual(BaseK8sTest):
    #For manual tests, do first the tests in test_resource, then the following 2
    def test_manual_test2(self):
